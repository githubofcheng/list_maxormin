...
//x,y:写入坐标
//color:颜色值
void LTDC_Draw_Point(u16 y,u16 x,u32 color)
{ 
#if LCD_PIXFORMAT==LCD_PIXFORMAT_ARGB8888||LCD_PIXFORMAT==LCD_PIXFORMAT_RGB888
	if(lcdltdc.dir)	//横屏
	{
...
//x,y:读取点的坐标
//返回值:颜色值
u32 LTDC_Read_Point(u16 y,u16 x)
{ 
#if LCD_PIXFORMAT==LCD_PIXFORMAT_ARGB8888||LCD_PIXFORMAT==LCD_PIXFORMAT_RGB888
	if(lcdltdc.dir)	//横屏
	{
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
    ...
    //初始化PH2,3,8,9,10,11,12,13,14,15
    GPIO_Initure.Pin=GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_11|\
    ...
    GPIO_Initure.Pin=GPIO_PIN_4|GPIO_PIN_5|\
                     GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2;
    HAL_GPIO_Init(GPIOI,&GPIO_Initure); 
		//初始化PG6,10,11,12
